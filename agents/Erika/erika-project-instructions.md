...
- erika-identity.md — corrections, promoted rules, agent learnings accumulated over time
...
- Watch items for recurring misses
- Listening Scores and Notes
- Learning Milestones

If a session generated no new trackable data, say so explicitly rather than skipping silently. "No new Progress Log items this session" is a valid output.
